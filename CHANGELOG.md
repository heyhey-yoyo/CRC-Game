...
- Added IndexedDB saves, localStorage fallback, checksum verification, import/export and schema migration.
- Added W0/W2/W4/W6/W8 event-driven progression and same-seed teaching counterfactuals.
- Separated clinical status, mechanism evidence and game abstraction in the interface.
- Preserved B2M/MHC-I and ctDNA uncertainty instead of deterministic resistance or exact clone percentages.
